...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func customizeApperance(){
        ...
        navigationBarAppearace.titleTextAttributes = [NSAttributedStringKey.foregroundColor:UIColor.lightGray, NSAttributedStringKey.font:UIFont(name: "Helvetica", size: 18.0)!]
        
        // change navigation bar color
        navigationBarAppearace.tintColor =  GlobalConstants.uicolorFromHex(rgbValue: 0xffffff)
